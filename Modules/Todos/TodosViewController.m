...
@interface TodosViewController () <WKNavigationDelegate>
...
- (void)viewDidLoad {
    ...
    // The page is a long-lived SPA — give it an explicit reload affordance
    // rather than relying on re-navigation.
