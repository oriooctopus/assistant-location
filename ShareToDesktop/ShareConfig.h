...
// GPSLogger/BakedConfig.h, so its endpoint is written out whole by CI (same
// DROP_HOST secret, substituted directly) rather than composed from a shared
// host macro.
//
...
#define GLDropEndpoint @"http://NO_HOST_BAKED_IN:8302/drop"
